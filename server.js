...
const ENEMY_TYPES = [
  { id:'basic', hp:40, speed:1.2, reward:5, radius:9 },
  { id:'fast', hp:20, speed:2.5, reward:6, radius:7 },
  { id:'tank', hp:120, speed:0.7, reward:12, radius:13 },
  { id:'flying', hp:50, speed:1.6, reward:10, radius:8, flying:true },
  { id:'boss', hp:500, speed:0.5, reward:50, radius:18 },
];
...
const BASE_SPEED = 0.00025; // slowed down significantly
